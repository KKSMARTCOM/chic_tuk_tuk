...
((n) => {
    ...
    V.util = {
        ...
        escapeHtml: function (e) {
            var t = typeof e;
            if ("function" != t)
                return "string" == t || Array.isArray(e) ? c(e) : e;
            c = e;
        },
        unique: w,
    };
            ...
            if (t.oFeatures.bAutoWidth) {
                ...
                var p = H(a.cloneNode())
                    ...
                    g =
                        (p.append("<tbody/>"),
                        p
                            .append(H(t.nTHead).clone())
                            .append(H(t.nTFoot).clone()),
    ...
    function Ne(t) {
        ...
        n.oFeatures.bProcessing &&
            ...
            m
                ? g.prependTo(H("div.dt-scroll", n.nTableWrapper))
                : g.insertBefore(e),
        ...
        var a,
            ...
            l =
                    ...
                    delete o.data),
                {
                    ...
                    error: function (e, t) {
                        (-1 ===
                            Z(n, null, "xhr", [n, null, n.jqXHR], !0).indexOf(
                                !0,
                            ) &&
                            ("parsererror" == t
    ...
    function tt(r, e, t) {
        ...
        if (e && e.time) {
            ...
            if (0 < s && e.time < +new Date() - 1e3 * s) r._bLoadingState = !1;
                ...
                -1 !==
                Z(r, "aoStateLoadParams", "stateLoadParams", [r, e]).indexOf(!1)
            )
                r._bLoadingState = !1;
            else {
                if (
                ...
                ((r._bLoadingState = !1),
                    Z(r, "aoStateLoaded", "stateLoaded", [r, e]));
            }
    ...
    function z(e, t, n, r) {
        if (
            ...
            if ((e && Z(e, null, "dt-error", [e, r, n], !0), "alert" == t))
                alert(n);
            else {
        ...
        (X.register = r =
            function (e, t) {
                if (Array.isArray(e))
                    ...
                    for (
                        var a = e.split("."), o = ct, i = 0, l = a.length;
                        i < l;
                        i++
                    ) {
                        var s,
    ...
    function yt(e, t, n) {
        ...
        if (void 0 !== n) a = n;
            ...
            for (var o = 0; o < r.length; o++)
                r[o][t].unique &&
                    H(".dt-column-title", r[o][t].cell).text() &&
                    (a = o);
            null === a && (a = 0);
        }
        return r[a][t].cell;
                ...
                function (n) {
                    ...
                    if ("function" == typeof n)
                        return (
                            (r = wt(i, l)),
                            c.map(function (e, t) {
                                return n(t, bt(i, t, 0, 0, r), yt(i, t))
                                    ? t
                                    : null;
                            })
                        );
                            ...
                            : "" === e
                              ...
                              : !(
                                ...
                                : "sort" === t
                                  ...
                                  : ((e =
                                        null === o
                                            ? Ot(r, "toDate", "toJSDate", "")[
                                                  u
                                              ](navigator.language, n)
                                            : Ot(
                                                  r,
                                                  "format",
                                                  "toFormat",
