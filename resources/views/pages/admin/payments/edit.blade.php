                    ...
                    <select name="driver_id" required
                        ...
                        @foreach ($drivers as $driver)
                            <option value="{{ $driver->id }}"
                                ...
                                {{ $driver->user?->name ?? 'N/A' }} (ID: {{ $driver->agent_id }})
                            </option>
                        @endforeach
                    </select>
                    @error('driver_id')
                ...
                <div>
                    ...
                    <select name="payment_type" required
                        ...
                        <option value="commission"
                            {{ (old('payment_type') ?? $payment->payment_type) == 'commission' ? 'selected' : '' }}>
                            Commission
                        </option>
                        <option value="contract"
                            {{ (old('payment_type') ?? $payment->payment_type) == 'contract' ? 'selected' : '' }}>
                            Contractuel
                        </option>
                    </select>
                    @error('payment_type')
