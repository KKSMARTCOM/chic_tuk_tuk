    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-12">
            <div class="text-center">
                <div
                    class="w-20 h-20 bg-[#FFE7C1] rounded-full flex items-center justify-center text-black text-3xl font-bold mx-auto mb-6">
            ...
            <div class="text-center">
                <div
                    class="w-20 h-20 bg-[#FFE7C1] rounded-full flex items-center justify-center text-black text-3xl font-bold mx-auto mb-6">
                    <i class="fas fa-user-check text-3xl text-gray-800"></i>
                </div>
            ...
            <div class="text-center">
                <div
                    class="w-20 h-20 bg-[#FFE7C1] rounded-full flex items-center justify-center text-black text-3xl font-bold mx-auto mb-6">
                    <i class="fas fa-route text-3xl text-gray-800"></i>
                </div>
