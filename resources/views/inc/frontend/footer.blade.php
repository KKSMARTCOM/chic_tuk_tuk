    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid md:grid-cols-4 gap-8">
            <div>
                ...
                <p class="text-white">Votre partenaire de mobilité urbaine</p>
            </div>
            <div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-white">
                    <li><i class="fas fa-phone mr-2"></i> +229 XX XX XX XX</li>
                    <li><i class="fas fa-envelope mr-2"></i> contact@gozem.bj</li>
        ...
        <div class="border-t border-white mt-8 pt-8 text-center text-white">
            <p>&copy; 2025 Gozem. Tous droits réservés.</p>
        </div>
    </div>
</footer>
