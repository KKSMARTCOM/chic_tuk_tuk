<div id="availabilityModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center px-4 z-20">
    <div class="bg-white rounded-lg p-6 max-w-md w-full">
        ...
        <p class="text-gray-600 mb-5" id="availabilityMessage"></p>
        <input type="hidden" id="availabilityDriverId"><input type="hidden" id="availabilityNewStatus">
        <div class="flex gap-3">
            <button onclick="closeAvailabilityModal()"
                class="flex-1 py-2 bg-gray-200 text-gray-700 rounded-lg">Annuler</button>
            <button onclick="confirmToggleAvailability()"
