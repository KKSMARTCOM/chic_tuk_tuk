...
<head>
    ...
    <title>{{ config('app.name') }} — 403 Non autorisé</title>
    ...
    <div class="w-full max-w-2xl">
        <div class="bg-white shadow-lg rounded-2xl overflow-hidden">
            ...
            <div class="p-8 sm:p-10 text-center">
                ...
                <p class="text-8xl font-extrabold text-gray-100 leading-none select-none mb-2">403</p>

                <h1 class="text-2xl font-bold text-gray-800 mb-3">Accès refusé</h1>
                <p class="text-gray-500 text-sm leading-relaxed mb-8">
                    Vous n'avez pas les droits pour accéder à cette page.<br>
