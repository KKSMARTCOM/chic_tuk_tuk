...
/*
|--------------------------------------------------------------------------
| Messages de validation (fr)
|--------------------------------------------------------------------------
|
| Laravel ne fournit pas de traduction française : sans ce fichier, toute règle
| sans message explicite retombe en anglais. Les contrôleurs Blade historiques
| contournaient le problème en réécrivant chaque message à la main ; les classes
| Data (spatie/laravel-data) s'appuient sur ces traductions par défaut et ne
| déclarent messages() que pour les formulations réellement spécifiques.
|
*/
...
return [
    ...
    /*
    | Messages spécifiques à un couple champ/règle : validation.custom.phone.required
    */
    'custom' => [],

    /*
    | Noms lisibles des champs, substitués à :attribute. Seuls les champs dont le nom
    | technique ne se lit pas bien en français sont repris ici.
    */
    'attributes' => [
        'from_lat'           => 'coordonnées du point de départ',
        'from_lng'           => 'coordonnées du point de départ',
        'to_lat'             => 'coordonnées de la destination',
        'to_lng'             => 'coordonnées de la destination',
        'from_location'      => 'ville de départ',
        'to_location'        => 'ville de destination',
        'pickup_date'        => 'date de départ',
        'pickup_time'        => 'heure de départ',
        'return_time'        => 'heure de retour',
        'week_days'          => 'jours de circulation',
        'round_trip'         => 'aller-retour',
        'base_price'         => 'prix de base',
        'special_requests'   => 'demandes spéciales',
        'tourist_circuit_id' => 'circuit touristique',
        ...
        'contract_months'    => 'durée du contrat',
    ],
];
